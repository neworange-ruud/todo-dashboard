...
describe('Bar', () => {
  it('carries the wordmark and the date', () => {
    render(<Bar dateLabel="Friday 11 September" sync={sync(2)} />)
  ...
  it('shifts the marker to the warning hue beyond 15 minutes (PRD §9)', () => {
    render(<Bar dateLabel="Friday 11 September" sync={sync(22)} />)
  ...
  it('treats a never-synced state as stale and says so in words', () => {
    render(<Bar dateLabel="Friday 11 September" sync={sync(null)} />)
  ...
  it('calls onRefresh when the marker is pressed', () => {
    ...
    render(<Bar dateLabel="Friday 11 September" sync={sync(1)} onRefresh={onRefresh} />)
